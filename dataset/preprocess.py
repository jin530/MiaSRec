...
elif opt.dataset in ['dressipi', 'dressipi_new']:
    dataset = 'raw/dressipi-all.csv'
elif opt.dataset == 'lastfm':
    dataset = 'raw/lastfm.csv'
...
with open(dataset, "r") as f:
    if opt.dataset in ['retailrocket', 'yoochoose']:
        ...
        reader = csv.DictReader(f, delimiter=';')
    elif opt.dataset in ['nowplaying', 'tmall', 'dressipi', 'dressipi_new', 'lastfm']:
        reader = csv.DictReader(f, delimiter='\t')
    sess_clicks = {}
    sess_date = {}
    ctr = 0
    ...
    for data in reader:
        ...
        elif opt.dataset in ['diginetica', 'yoochoose', 'retailrocket', 'dressipi', 'dressipi_new']:
        ...
        if curdate and not curid == sessid:
            ...
            if opt.dataset == 'yoochoose':
                ...
                date = time.mktime(time.strptime(curdate[:22],'%Y-%m-%d %H:%M:%S.%f'))
        ...
        curid = sessid
        if opt.dataset in ['yoochoose', 'retailrocket', 'dressipi', 'dressipi_new']:
            item = data['item_id']
        elif opt.dataset == 'diginetica':
            ...
            raise ValueError()
        curdate = ''
        if opt.dataset in ['yoochoose', 'retailrocket', 'lastfm']:
